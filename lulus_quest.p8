		...
		for b in all(butterflies) do
			if collision_light(c, b) then
				...
				elseif b.light == "black" then
					c.in_light = c == lulu and true or false
				elseif b.light == "dark" then
					c.in_light = c == hades and true or false
				end
			end
		end
	end
...
function init_room()
	...
	--lvl 20
	{
		...
		butterflies = {{53,44,53,44,62,44,2,0.5,10,"dark"}},
	...
	--23
	{
		...
		powers = {3,1},
		butterflies = {
			{95,33,95,33,112,33,2,1,12,"black"},
...
function draw_ui()
	...
	if lulu.powers_left > 0 then
		...
		palt(0, false)
		local lpower = lulu.powers_left
		print(lpower, x-1, ly, 0)
		print(lpower, x+1, ly, 0)
		print(lpower, x, ly-1, 0)
		print(lpower, x, ly+1, 0)
		print(lpower, x, ly, 11)
	end
	...
	if hades.powers_left > 0 then
		spr(50, room.x + 4, hy)
		local hpower = hades.powers_left
		print(hpower, x-1, hy, 0)
		print(hpower, x+1, hy, 0)
		print(hpower, x, hy-1, 0)
		print(hpower, x, hy+1, 0)
		print(hpower, x, hy, 11)
	end
...
function debug_print()
	...
	-- end
	print("lulu_c:")
	print(lulu.in_light and "true" or "false")
	print("hades_c:")
	print(hades.in_light and "true" or "false")
	print("bf_d:"..butterflies[1].light)
...

...
a600360024366596552474000000d695a10200000000000000020062000000000000910000000000000000000000000002000000000000020000000000003302
...
000036002436000000242500000044d6620202000002020202020202000000000275757575757575757575757500000002910000000000020000000000000002
...
50003626243600000024252600000000020000000000000000000002020000000000000000000000000000007500007502020200000000020000000000020202
...
94946767677400007467949494a46444000000000000001000000000000000000000000010757575750000007500000002000000000000430000000002020002
...
95a51405142500000016d695f5a50000000002020000027575020000000000000000000075a0a0a0a07500007500000002000000000002020202000202000002
...
95a61607161400000017068695a50000000000000002023233020200000002000000007500a00000a00075007575000002c4c4020202c5c5c5c5020000000002
...
a6000005140514211706001685a50000000000000202020000020202000000000000007532a00000a03375007500000002c4c4c4c402c5c5c5c5020000000002
...
0700000016148494a454545486a60000020000000002020202020200000000000000007500a00000a00075007500000002c4c4c4c402c5c5c5c5020000000002
...
061000000084959695a4350000003233000200000000020202020000000200000000000074a0a0a0a0740000750000750202c4c4c402c510c5c5020000000002
...

...
a2a2a2a2a2a2a2a2a2a2a2a2a2a2a2a250000002a202020202a2a2020200000075757574757574a1747575757574000002000000000202757502020202020202
...
9595b38696969595959696969696969602020202a3a3a30202a3a3a3020002920000000000000000000000000000000002000000020202008402020202020202
...
95f5b30000008696a600000000000000a3a3a3a3a3a3a30202020202020002024150620000000074000000000000006202500000020202328502020202020202
...
9595b3a2a2a2a2a2a2a2a28494949494b3b3b3b3b3b3b30291910000430002a30202020202020202020202020202020202020202020202008502020202020202
...
02000000000000000000000000000002000000000000000000000000000000020275750000000000007575750202020202000000000000000000000000000002
...
02000000000000000000000000000002000000000000000000000000000000020275757500000000007575750000000202000000c4c4c4c40000000000000002
...

