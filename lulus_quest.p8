...
function update_objects()
	...
	foreach(shield_cristals, function(sc)
		if collision(lulu,sc) then
			sfx(5)			
			if sc.lives and not lulu.shield.active or lulu.shield.timer > lulu.shield.time_set * 0.8 then
				sc.lives = sc.lives - 1
				if sc.lives <= 0 then
...
function draw_objects()
	...
	--shield cristals
	foreach(shield_cristals, function(sc)
		print(sc.lives, sc.x + 8, sc.y - 2, 11)
...

...

...

...

