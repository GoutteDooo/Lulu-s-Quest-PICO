...
function init_room()
    ...
    --15 HEART
    {
        ...
        pulsator = {
            ...
            pulse_timer = 0,
            beat_delay = 210,
            light_data = {r_max = 128, type = nil, spd = 1, ac_activated = 0 }, 
        },
    ...
    --16
    {
			...
			butterflies = {
				...
				{1,36, 1,36,1,48, 2,0.6, 8,"anti", false},
...
function update_objects()
	...
	foreach(acristals, function(ac)
		if not ac.active and collision(pactual,ac) then
			ac.active = true
			pulsator[1].light_data.ac_activated += 1
			create_light(ac.x, ac.y, 12, "black")
		end
	end)
end
...
function create_objects()
	...
	foreach(room.acristals, function(ac)
		add(acristals, {x = ac[1] * 8, y = ac[2] * 8, active = false})
	end)
end
...

...

...
02020202020202020202020202020202020202020202020202020202020202020202020202020202020202020202020200000000000000000000000000000000
__gff__

