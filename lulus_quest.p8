...
function _draw()
	if game_state == 0 then
		...
		if title_light_animation then
			-- Fade out effect
			local fade = title_animation_frame / title_animation_duration
			if fade < 0.5 then
				-- First half: darken colors
				for i = 1, 15 do
					local dark = i * fade * 2
					pal(i, i + dark)
				end
			else
				-- Second half: brighten colors
				for i = 1, 15 do
					local bright = i * (1 - fade) * 2
					pal(i, i + bright)
				end
			end
		end
...
00000444c0a7a0ccc80008cc055dd5500044440000000000000b00009974449946665554c0a9a0cc88848888888888880000113555555d33dddddd3351110000
...
00000000ccc0ccccccc8cccc5d2272d50044440000000000000b00009744444997444449cc0a0ccc888888488888888800000000011111111311111000000000
