...
function init_room()
	...
	--22
	{
		...
		p_data = {94.5,29.5,240,"white",0,16,1.5}
...
function draw_ui()
	...
	if lulu.powers_left > 0 then
		...
		print(lulu.powers_left, x+1, ly, 0)
		print(lulu.powers_left, x, ly-1, 0)
		print(lulu.powers_left, x, ly+1, 0)
		-- palt(0, true)
		print(lulu.powers_left, x, ly, 11)
	end
	...
	if hades.powers_left > 0 then
		spr(50, room.x + 4, hy)
		-- palt(0, false)
		print(hades.powers_left, x-1, hy, 0)
		print(hades.powers_left, x+1, hy, 0)
		print(hades.powers_left, x, hy-1, 0)
		print(hades.powers_left, x, hy+1, 0)
		print(hades.powers_left, x, hy, 11)
	end
	-- for i = 1, hades.powers_left do
		...
		if gkeys > 0 then
		spr(57, room.x + 4, gky)
		print(gkeys, x-1, gky, 0)
		print(gkeys, x+1, gky, 0)
		print(gkeys, x, gky-1, 0)
		print(gkeys, x, gky+1, 0)
		print(gkeys, x, gky,11)
		end
		if wkeys > 0 then
		spr(9, room.x + 4, wky)
		print(wkeys, x-1, wky, 0)
		print(wkeys, x+1, wky, 0)
		print(wkeys, x, wky-1, 0)
		print(wkeys, x, wky+1, 0)
		print(wkeys, x, wky,11)
		end
	palt()
end
...

...
000036002436000000242500000044d6020200020200000202000002000000007400000000000000000000000000000202000000000000000000000000000002
...

...

...

__sfx__
