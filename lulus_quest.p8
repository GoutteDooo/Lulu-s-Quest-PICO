...
function init_room()
    ...
    --16
    {
			...
			butterflies = {
				...
				{2,36, 2,36,2,50, 2,0.5, 8,"anti", false},
	...
	foreach(acristals, function(ac)
		for c in all(chars) do
			if not ac.active and collision(c,ac) then
				...
				break
			elseif ac.active and not collision(c,ac) then
				ac.active = false
				pulsator[1].light_data.ac_activated -= 1
			end
		end
...

...

...

...

